<%-- 
    ...
    Created on : Mar 4, 2024, 9:22:24 PM
    Author     : quang
--%>
    ...
    <section id="banner" class="py-3" style="background: #F9F3EC;">
        <div class="container">
            <div class="hero-content py-5 my-3">
                <h2 class="display-1 mt-3 mb-0"><span class="text-primary">Liên hệ</span> </h2>
                <nav class="breadcrumb">
                    <a class="breadcrumb-item nav-link" href="home">Trang chủ</a>
                    <span class="breadcrumb-item active" aria-current="page">Cách thức liên hệ</span>
                </nav>
            </div>
        </div>
    </section>
        ...
        <div class="container py-5 my-5">
            <div class="row">
                <div class="contact-info col-lg-4 pb-3">
                    <h2 class="text-dark">Thông tin liên hệ</h2>
                    <p>Mọi thắc mắc của quý khách xin vui lòng liên hệ qua các cách dưới đây.</p>
                    <div class="page-content d-flex flex-wrap mt-5">
                        <div class="col-lg-12 col-sm-12">
                            <div class="content-box text-dark pe-4 mb-5">
                                <h4 class="card-title">Văn phòng</h4>
                                <div class="contact-address pt-3">
                                    <h5 class="card-title">Địa chỉ</h5>
                                    <p>Thôn 3,Thạch Hòa, Thạch Thất, Hà Nội</p>
                                </div>
                ...
                <div class="inquiry-item col-lg-8">
                    <div class="rounded-5">
                        <h2 class="text-dark">Bạn có bất cứ câu hỏi nào?</h2>
                        ...
                        <form id="form" class="form-group flex-wrap">
                            <div class="form-input col-lg-12 d-flex mb-3">
                                <input type="text" name="email" placeholder="Nhập họ và tên" class="form-control ps-3 me-3">
                                <input type="text" name="email" placeholder="Nhập Email" class="form-control ps-3">
                            </div>
                            <div class="col-lg-12 mb-3">
                                <input type="text" name="email" placeholder="Nhập số điện thoại" class="form-control ps-3">
                            </div>
                            <div class="col-lg-12 mb-3">
                                <input type="text" name="email" placeholder="Nhập tiêu đề" class="form-control ps-3">
                            </div>
                            <div class="col-lg-12 mb-3">
                                <textarea placeholder="Nội dung liên hệ" class="form-control ps-3"
