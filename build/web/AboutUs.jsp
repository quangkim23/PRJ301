<%-- 
    ...
    Created on : Mar 4, 2024, 10:04:12 PM
    Author     : quang
--%>
...
<jsp:include page="Header.jsp"></jsp:include>
    ...
    <section id="banner" class="py-3" style="background: #F9F3EC;">
        <div class="container">
            <div class="hero-content py-5 my-3">
                <h2 class="display-1 mt-3 mb-0"><span class="text-primary">Giới thiệu về chúng tôi</span> </h2>
                <nav class="breadcrumb">
                    <a class="breadcrumb-item nav-link" href="home">Trang chủ</a>
                    <span class="breadcrumb-item active" aria-current="page">Về chúng tôi</span>
                </nav>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row ">
                <div class="col-md-6 my-4 pe-5">
                    <h2 class="">Petshop ra đời như thế nào</h2>
                    <p>Petshop bắt đầu với sứ mệnh mang lại những sản phẩm chất lượng tốt nhất cho thú cưng của bạn.
                        Chúng tôi luôn nỗ lực để cung cấp những sản phẩm chăm sóc thú cưng tốt nhất, giúp thú cưng của bạn luôn khỏe mạnh và hạnh phúc.</p>
                ...
                <div class="col-md-6 my-4 ">
                    <h2 class="">Thêm về chúng tôi </h2>
                    <p>Petshop cam kết mang lại cho khách hàng những sản phẩm chất lượng nhất và dịch vụ tốt nhất. 
                        Chúng tôi không chỉ cung cấp các sản phẩm chăm sóc thú cưng mà còn tạo ra một môi trường mua sắm thuận tiện và trải nghiệm tuyệt vời cho các chủ thú cưng.</p>
                    <p class="m-0"> <span class="text-primary">✓</span> Chúng tôi cam kết mang lại sự hài lòng tuyệt đối cho khách hàng.</p>
                    <p class="m-0"> <span class="text-primary">✓</span> Chúng tôi luôn luôn lắng nghe ý kiến của khách hàng để cải thiện dịch vụ.</p>
                    <p class="m-0"> <span class="text-primary">✓</span> Chúng tôi không ngừng nâng cao chất lượng sản phẩm và dịch vụ.</p>
                    <p class="m-0"> <span class="text-primary">✓</span> Chúng tôi tự hào về đội ngũ nhân viên giàu kinh nghiệm và nhiệt huyết.</p>
                </div>
            </div>
        </div>
    </div>
    <div class="my-5 pb-5">
        <div class="container">
            <div class="row ">
                <div class="col-md-6">
                    <h2 class="display-4">Bạn có thể mua những sản phẩm chất lượng tốt nhất từ Petshop</h2>
                </div>
                <div class="col-md-6">
                    <p>Petshop mang lại cho bạn sự lựa chọn đa dạng với những sản phẩm chất lượng cao, từ thức ăn, đồ chơi cho đến đồ dùng chăm sóc thú cưng. Chúng tôi tin rằng thú cưng của bạn xứng đáng được chăm sóc và yêu thương nhất.</p>
                    <p>Chúng tôi luôn luôn cam kết mang lại trải nghiệm mua sắm trực tuyến thuận tiện, nhanh chóng và an toàn cho tất cả các khách hàng của mình.</p>
                </div>
            </div>
        </div>
    </div>
